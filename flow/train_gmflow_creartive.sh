...
python -u train_gmflow.py  --name gmflow-creative-ft  --stage creative --validation anime --restore_ckpt models/gmflow_with_refine_sintel-3ed1cf48.pth --gpus 0 1 --num_steps 20000 --batch_size 6 --lr 0.0001 --image_size 480 480 --wdecay 0.00001 --gamma=0.85 --mixed_precision 
